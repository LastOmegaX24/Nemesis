...
{
  return GetValid(Value) == GetValid(OtherValue);
}
...
void TSyncType<FActorBase>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{
  if (Value)
  {
...
void TSyncType<FLinearVelocity>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FAngularVelocity>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FActorLocation>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FActorRotation>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FActorScale>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FControlRotation>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FBit>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FUnsignedInt4>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FUnsignedInt8>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FInt32>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FFloat>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FFloat2Dec>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FDouble>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FDouble2Dec>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FDoubleAsFloat>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FVector2Double2Dec>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FVector3Double2Dec>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FRotator3Double2Dec>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FActorReference>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{
  if (Value)
  {
    ...
    Collector.AddReferencedObject(Value);
#else
    FReferenceCollector::AROPrivate::AddReferencedObject<AActor>(Collector, Value);
#endif
  }
}
...
void TSyncType<FActorComponentReference>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{
  if (Value)
  {
#if UE_VERSION_OLDER_THAN(5, 3, 0)
    Collector.AddReferencedObject(Value);
#else
    FReferenceCollector::AROPrivate::AddReferencedObject<UActorComponent>(Collector, Value);
#endif
  }
}
...
void TSyncType<FAnimMontageReference>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{
  if (Value)
  {
#if UE_VERSION_OLDER_THAN(5, 3, 0)
    Collector.AddReferencedObject(Value);
#else
    FReferenceCollector::AROPrivate::AddReferencedObject<UAnimMontage>(Collector, Value);
#endif
  }
}
...
void TSyncType<FName>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FGameplayTag>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FGameplayTagContainer>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{}
...
void TSyncType<FInstancedStruct>::AddReferencedObjects(UType& Value, FReferenceCollector& Collector)
{
  Value.AddStructReferencedObjects(Collector);
}
