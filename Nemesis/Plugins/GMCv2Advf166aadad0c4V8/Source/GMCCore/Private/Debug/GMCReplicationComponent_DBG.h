...
#define DEBUG_LOG_FORCED_NET_UPDATES_CLIENT_CORRECTION\
  ...
  {\
    GMC_LOG(LogGMCReplication, PawnOwner, Log, TEXT("Log forced net updates ::: Forced update due to client correction (actor net update frequency = %f)"), GetOwnerNetUpdateFrequency())\
  }
