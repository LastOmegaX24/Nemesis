...
public:
  ...
  /// Returns whether path following is using a fixed braking distance.
  ///
  /// @returns      bool    Whether path following is currently using a fixed braking distance.
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  virtual bool IsUsingFixedBrakingDistanceForPathFollowing() const;

  /// Returns the currently configured fixed braking distance for path following.
  ///
  /// @returns      float    The currently configured fixed braking distance for path following.
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  virtual float GetFixedBrakingDistanceForPathFollowing() const;
