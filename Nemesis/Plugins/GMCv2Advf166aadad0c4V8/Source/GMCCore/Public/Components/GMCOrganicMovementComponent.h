...
protected:
  ...
  /// @param        DeltaSeconds          The delta time to use.
  /// @returns      void
  virtual void CalculateAnimRootMotionVelocity(const FGMC_RootMotionExtractionSettings& ExtractionSettings, float MontageDelta, float DeltaSeconds);
  ...
  /// @param        DeltaSeconds          The delta time to use.
  /// @returns      void
  virtual void ApplyAnimRootMotionRotation(const FGMC_RootMotionExtractionSettings& ExtractionSettings, float MontageDelta, float DeltaSeconds);
  ...
  UFUNCTION(BlueprintNativeEvent, Category = "General Movement Component")
  FVector PostProcessAnimRootMotionVelocity(const FVector& RootMotionVelocity, float MontageDelta, float DeltaSeconds);
  virtual FVector PostProcessAnimRootMotionVelocity_Implementation(const FVector& RootMotionVelocity, float MontageDelta, float DeltaSeconds) { return RootMotionVelocity; }
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageStarted(UAnimMontage* Montage, float Position, float PlayRate, bool bInterrupted, float MontageDelta, float DeltaSeconds) {}
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageBlendIn(UAnimMontage* Montage, float Position, float PlayRate, float MontageDelta, float DeltaSeconds) {}
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageBlendOut(UAnimMontage* Montage, float Position, float PlayRate, float MontageDelta, float DeltaSeconds) {}
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageCompleted(UAnimMontage* Montage, float Position, float PlayRate, float MontageDelta, float DeltaSeconds) {}
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageNotifyBegin(const FName& NotifyName, UAnimMontage* Montage, float Position, float PlayRate, float MontageDelta, float DeltaSeconds) {}
  ...
  /// @param        DeltaSeconds    The current move delta time.
  /// @returns      void
  virtual void OnMontageNotifyEnd(const FName& NotifyName, UAnimMontage* Montage, float Position, float PlayRate, float MontageDelta, float DeltaSeconds) {}
