...
public:
  ...
  /// Returns the currently configured net update frequency of the owning pawn.
  ///
  /// @returns      float    The current net update frequency of the pawn.
  UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "General Movement Component")
  float GetOwnerNetUpdateFrequency() const;
  ...
  ///
  /// @param        Base    The component to base the owning pawn on. Must not be owned by the pawn itself.
  /// @returns      void
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
