...
static const FName NAME_AGMC_RollbackActor_LoadState = FName(TEXT("LoadState"));
void AGMC_RollbackActor::LoadState(EGMC_NetContext Context)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_RollbackActor_LoadState);
	...
	{
		LoadState_Implementation(Context);
	}
}
...
static const FName NAME_AGMC_RollbackActor_SaveState = FName(TEXT("SaveState"));
void AGMC_RollbackActor::SaveState(EGMC_NetContext Context)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_RollbackActor_SaveState);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SaveState_Implementation(Context);
	}
}
...
static const FName NAME_AGMC_RollbackActor_UpdateState = FName(TEXT("UpdateState"));
void AGMC_RollbackActor::UpdateState(double Time, float DeltaTime, FGMC_Move const& Move, EGMC_NetContext Context)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_RollbackActor_UpdateState);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		UpdateState_Implementation(Time, DeltaTime, Move, Context);
	}
}
...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCRollbackActor_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGMC_RollbackActor, AGMC_RollbackActor::StaticClass, TEXT("AGMC_RollbackActor"), &Z_Registration_Info_UClass_AGMC_RollbackActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGMC_RollbackActor), 1683221056U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCRollbackActor_h_3106633686(TEXT("/Script/GMCCore"),
