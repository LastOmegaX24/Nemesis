...
static const FName NAME_AGMC_Pawn_OnControllerChanged = FName(TEXT("OnControllerChanged"));
void AGMC_Pawn::OnControllerChanged(AController* NewController, AController* OldController)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_Pawn_OnControllerChanged);
	...
	{
		OnControllerChanged_Implementation(NewController, OldController);
	}
}
...
static const FName NAME_AGMC_Pawn_SV_ReceiveClientSendStatus = FName(TEXT("SV_ReceiveClientSendStatus"));
void AGMC_Pawn::SV_ReceiveClientSendStatus(bool bIsUsingUnreliableMoves)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AGMC_Pawn_SV_ReceiveClientSendStatus);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_AGMC_Pawn_SV_ReceiveMovesReliable = FName(TEXT("SV_ReceiveMovesReliable"));
void AGMC_Pawn::SV_ReceiveMovesReliable(TArray<FGMC_Move> const& RemoteMoves)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AGMC_Pawn_SV_ReceiveMovesReliable);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_AGMC_Pawn_SV_ReceiveMovesUnreliable = FName(TEXT("SV_ReceiveMovesUnreliable"));
void AGMC_Pawn::SV_ReceiveMovesUnreliable(TArray<FGMC_Move> const& RemoteMoves)
{
	...
	Parms.RemoteMoves=RemoteMoves;
	UFunction* Func = FindFunctionChecked(NAME_AGMC_Pawn_SV_ReceiveMovesUnreliable);
	ProcessEvent(Func,&Parms);
}
...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCPawn_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGMC_Pawn, AGMC_Pawn::StaticClass, TEXT("AGMC_Pawn"), &Z_Registration_Info_UClass_AGMC_Pawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGMC_Pawn), 3405627880U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCPawn_h_803196712(TEXT("/Script/GMCCore"),
