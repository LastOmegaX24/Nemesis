...
static const FName NAME_AGMC_PlayerController_CL_SendAdaptiveDelayParams = FName(TEXT("CL_SendAdaptiveDelayParams"));
void AGMC_PlayerController::CL_SendAdaptiveDelayParams(TArray<FGMC_AdaptiveDelayServerPacket> const& AdaptiveDelayParams)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AGMC_PlayerController_CL_SendAdaptiveDelayParams);
...
static const FName NAME_AGMC_PlayerController_ManualUpdateCamera = FName(TEXT("ManualUpdateCamera"));
void AGMC_PlayerController::ManualUpdateCamera(float DeltaTime)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_PlayerController_ManualUpdateCamera);
	...
	{
		ManualUpdateCamera_Implementation(DeltaTime);
	}
}
...
static const FName NAME_AGMC_PlayerController_SV_OnPawnLeavingGame = FName(TEXT("SV_OnPawnLeavingGame"));
void AGMC_PlayerController::SV_OnPawnLeavingGame()
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_PlayerController_SV_OnPawnLeavingGame);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		SV_OnPawnLeavingGame_Implementation();
	}
}
...
static const FName NAME_AGMC_PlayerController_SV_RequestAdaptiveDelayBufferTime = FName(TEXT("SV_RequestAdaptiveDelayBufferTime"));
void AGMC_PlayerController::SV_RequestAdaptiveDelayBufferTime(FGMC_AdaptiveDelayClientPacket const& NewBufferTime) const
{
	...
	UFunction* Func = FindFunctionChecked(NAME_AGMC_PlayerController_SV_RequestAdaptiveDelayBufferTime);
		const_cast<AGMC_PlayerController*>(this)->ProcessEvent(Func,&Parms);
}
...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCPlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGMC_PlayerController, AGMC_PlayerController::StaticClass, TEXT("AGMC_PlayerController"), &Z_Registration_Info_UClass_AGMC_PlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGMC_PlayerController), 1020568367U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCPlayerController_h_3052822723(TEXT("/Script/GMCCore"),
