...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Replication_WorldTime_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGMC_WorldTimeReplicator, AGMC_WorldTimeReplicator::StaticClass, TEXT("AGMC_WorldTimeReplicator"), &Z_Registration_Info_UClass_AGMC_WorldTimeReplicator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGMC_WorldTimeReplicator), 1841667520U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Replication_WorldTime_h_1344256969(TEXT("/Script/GMCCore"),
