...
static const FName NAME_AGMC_Aggregator_OnAggregateTickToggled = FName(TEXT("OnAggregateTickToggled"));
void AGMC_Aggregator::OnAggregateTickToggled(bool bEnabled)
{
	UFunction* Func = FindFunctionChecked(NAME_AGMC_Aggregator_OnAggregateTickToggled);
	...
	{
		OnAggregateTickToggled_Implementation(bEnabled);
	}
}
...
struct Z_Construct_UClass_AGMC_Aggregator_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bAggregateMeshComponents_MetaData[] = {
		{ "Category", "Groups" },
		{ "Comment", "/// Aggregating mesh components can cause problems with animation multithreading, leave disabled.\n" },
		{ "ModuleRelativePath", "Public/Actors/GMCAggregator.h" },
		{ "ToolTip", "Aggregating mesh components can cause problems with animation multithreading, leave disabled." },
	};
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AGMC_Aggregator_Statics::NewProp_bAggregateMeshComponents = { "bAggregateMeshComponents", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AGMC_Aggregator), &Z_Construct_UClass_AGMC_Aggregator_Statics::NewProp_bAggregateMeshComponents_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bAggregateMeshComponents_MetaData), NewProp_bAggregateMeshComponents_MetaData) };
...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCAggregator_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGMC_Aggregator, AGMC_Aggregator::StaticClass, TEXT("AGMC_Aggregator"), &Z_Registration_Info_UClass_AGMC_Aggregator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGMC_Aggregator), 3397823133U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Actors_GMCAggregator_h_3029485468(TEXT("/Script/GMCCore"),
