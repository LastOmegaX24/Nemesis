...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Components_GMCFlatCapsuleComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGMC_FlatCapsuleCmp, UGMC_FlatCapsuleCmp::StaticClass, TEXT("UGMC_FlatCapsuleCmp"), &Z_Registration_Info_UClass_UGMC_FlatCapsuleCmp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGMC_FlatCapsuleCmp), 1427262946U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Components_GMCFlatCapsuleComponent_h_3434007217(TEXT("/Script/GMCCore"),
