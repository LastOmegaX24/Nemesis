...
static const FName NAME_UGMC_GoldSrcMovementCmp_ApplyJumpSpeedBoost = FName(TEXT("ApplyJumpSpeedBoost"));
void UGMC_GoldSrcMovementCmp::ApplyJumpSpeedBoost(float DeltaSeconds)
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_ApplyJumpSpeedBoost);
	...
	{
		ApplyJumpSpeedBoost_Implementation(DeltaSeconds);
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_CanCrouch = FName(TEXT("CanCrouch"));
bool UGMC_GoldSrcMovementCmp::CanCrouch() const
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_CanCrouch);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
		GMC_GoldSrcMovementCmp_eventCanCrouch_Parms Parms;
		const_cast<UGMC_GoldSrcMovementCmp*>(this)->ProcessEvent(Func,&Parms);
		return !!Parms.ReturnValue;
	}
	else
	{
		return const_cast<UGMC_GoldSrcMovementCmp*>(this)->CanCrouch_Implementation();
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_CanJump = FName(TEXT("CanJump"));
bool UGMC_GoldSrcMovementCmp::CanJump() const
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_CanJump);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGMC_GoldSrcMovementCmp*>(this)->CanJump_Implementation();
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_CanSprint = FName(TEXT("CanSprint"));
bool UGMC_GoldSrcMovementCmp::CanSprint() const
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_CanSprint);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGMC_GoldSrcMovementCmp*>(this)->CanSprint_Implementation();
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_CanUncrouch = FName(TEXT("CanUncrouch"));
bool UGMC_GoldSrcMovementCmp::CanUncrouch() const
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_CanUncrouch);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		return const_cast<UGMC_GoldSrcMovementCmp*>(this)->CanUncrouch_Implementation();
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_Crouch = FName(TEXT("Crouch"));
void UGMC_GoldSrcMovementCmp::Crouch(bool bRequestedCrouch, float DeltaSeconds)
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_Crouch);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		Crouch_Implementation(bRequestedCrouch, DeltaSeconds);
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_Jump = FName(TEXT("Jump"));
void UGMC_GoldSrcMovementCmp::Jump(bool bRequestedJump, float DeltaSeconds)
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_Jump);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		Jump_Implementation(bRequestedJump, DeltaSeconds);
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_OnJumped = FName(TEXT("OnJumped"));
void UGMC_GoldSrcMovementCmp::OnJumped()
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_OnJumped);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
...
static const FName NAME_UGMC_GoldSrcMovementCmp_Sprint = FName(TEXT("Sprint"));
void UGMC_GoldSrcMovementCmp::Sprint(bool bRequestedSprint, float DeltaSeconds)
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_Sprint);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		Sprint_Implementation(bRequestedSprint, DeltaSeconds);
	}
}
...
static const FName NAME_UGMC_GoldSrcMovementCmp_WaterJump = FName(TEXT("WaterJump"));
void UGMC_GoldSrcMovementCmp::WaterJump(float DeltaSeconds)
{
	UFunction* Func = FindFunctionChecked(NAME_UGMC_GoldSrcMovementCmp_WaterJump);
	if (!Func->GetOwnerClass()->HasAnyClassFlags(CLASS_Native))
	{
	...
	{
		WaterJump_Implementation(DeltaSeconds);
	}
}
...
struct Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Components_GMCGoldSrcMovementComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGMC_GoldSrcMovementCmp, UGMC_GoldSrcMovementCmp::StaticClass, TEXT("UGMC_GoldSrcMovementCmp"), &Z_Registration_Info_UClass_UGMC_GoldSrcMovementCmp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGMC_GoldSrcMovementCmp), 1908973924U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_build_U5M_Marketplace_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_GMC_Source_GMCCore_Public_Components_GMCGoldSrcMovementComponent_h_79494690(TEXT("/Script/GMCCore"),
