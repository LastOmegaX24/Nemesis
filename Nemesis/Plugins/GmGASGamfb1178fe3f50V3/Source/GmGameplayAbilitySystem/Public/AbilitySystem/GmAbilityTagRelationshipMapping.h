...
#include "GmAbilityTagRelationshipMapping.generated.h"

class UObject;

/** Struct that defines the relationship between different ability tags */
USTRUCT()
struct FGmAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class GMGAMEPLAYABILITYSYSTEM_API UGmAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()

	/** The list of relationships between different gameplay tags (which ones block or cancel others) */
	UPROPERTY(EditAnywhere, Category = Ability, meta = (TitleProperty="AbilityTag"))
	TArray<FGmAbilityTagRelationship> AbilityTagRelationships;
